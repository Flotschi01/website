        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center space-y-12 lg:pl-12">
            <div className="relative pt-4">
              ...
              <div className="relative pt-4">
              <a 
                href="/Zertifikat_Tierkommunikation.pdf" // Replace with your actual PDF link or dynamic state
              ...
              >
                ...
                <p className="text-[var(--color-primary)]">Zertifikat Tierkommunikation</p>
                          ...
                          <div className="relative pt-4">
              <a 
                href="/Zertifikat_Tierenergetik.pdf" // Replace with your actual PDF link or dynamic state
            ...
            <div className="relative pt-4">
              <div className="text-xl font-medium text-[var(--color-primary)] relative z-10 pl-2">
                {t('Qualifikationen 2', 'Lade Inhalt')}
                            ...
                            <div className="relative pt-4">
              <a 
                href="/Zertifikate_Homöopathie.pdf" // Replace with your actual PDF link or dynamic state
